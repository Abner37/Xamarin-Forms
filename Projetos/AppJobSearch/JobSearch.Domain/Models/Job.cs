...
namespace JobSearch.Domain.Models
{
    public class Job
    {
        ...
        [Display(Name = "CompanyDescription", ResourceType = typeof(Utility.Language.Fields))]
        ...
        [Display(Name = "Benefits", ResourceType = typeof(Utility.Language.Fields))]
        public string Benefits { get; set; }

        [Display(Name = "InterestSendEmailTo", ResourceType = typeof(Utility.Language.Fields))]
        [Required(ErrorMessageResourceType = typeof(Utility.Language.Messages), ErrorMessageResourceName = "MSG_E001")]
        ...
        [Display(Name = "PublicationDate", ResourceType = typeof(Utility.Language.Fields))]
